"""Legacy EXP-380 sample summaries for semantically parsed range events.

This module intentionally preserves the historical four-column experiment contract.
The current fold-safe gene indicators live in :mod:`range_semantic_features`.
"""
