#!/usr/bin/env python
"""Run EXP-369: isolated stop notation normalization on EXP-229."""
...
CONFIG = ROOT / "configs" / "exp369_stop_notation_normalization.yaml"
MEMBERSHIP = ROOT / "reports" / "exp369_stop_notation_normalization" / "pathway_membership.json"
...
if __name__ == "__main__":
    main(
        ...
        runner_command=(
            "uv run python scripts/run_exp369_stop_notation_normalization.py"
        ),
    )
