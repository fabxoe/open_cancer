#!/usr/bin/env python
"""Run EXP-541 hierarchical row-L2 LinearSVC canonical 5-fold."""
...
CONFIG_PATH = ROOT / "configs/exp541_hierarchical_row_l2_linear.yaml"
SLUG = "exp541_hierarchical_row_l2_linear"
...
def main() -> None:
    ...
    if config["experiment_id"] != "EXP-541" or config["issue_number"] != 541:
        raise ValueError("EXP-541 identity mismatch")
    ...
    metrics = {
        "experiment_id": "EXP-541", "record_role": "official", "status": "COMPLETED",
        "owner": "fabxoe", "issue_number": 541, "parent_experiment": "EXP-539",
        ...
        "decision": "PENDING_COMPARISON_WITH_EXP539",
        "artifacts": {
