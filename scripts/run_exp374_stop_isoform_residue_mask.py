#!/usr/bin/env python
"""Run EXP-374: EXP-369 stop normalization plus Ensembl residue mask."""
...
CONFIG = ROOT / "configs" / "exp374_stop_isoform_residue_mask.yaml"
MEMBERSHIP = (
...
if __name__ == "__main__":
    main(
        ...
        runner_command="uv run python scripts/run_exp374_stop_isoform_residue_mask.py",
    )
