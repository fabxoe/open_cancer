#!/usr/bin/env python
"""Run EXP-527: leave-one-out outer-train parser-v4 class cosine profiles."""
...
CONFIG = ROOT / "configs" / "exp527_parser_v4_class_cosine_loo.yaml"


class LeaveOneOutClassCosineFoldBuilder:
...
if __name__ == "__main__":
    main(
        CONFIG,
        fold_feature_builder=LeaveOneOutClassCosineFoldBuilder(),
        ...
        runner_command="uv run python scripts/run_exp527_parser_v4_class_cosine_loo.py",
    )
