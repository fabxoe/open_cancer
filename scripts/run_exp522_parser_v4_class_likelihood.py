#!/usr/bin/env python
"""Run EXP-522: EXP-374 plus fold-safe parser-v4 class likelihood profiles."""
...
CONFIG = ROOT / "configs" / "exp522_parser_v4_class_likelihood.yaml"


class ClassLikelihoodFoldBuilder:
...
if __name__ == "__main__":
    main(
        CONFIG,
        fold_feature_builder=ClassLikelihoodFoldBuilder(),
        ...
        runner_command="uv run python scripts/run_exp522_parser_v4_class_likelihood.py",
    )
