#!/usr/bin/env python
"""Run EXP-639: EXP-527 plus fold-safe parser-v4 Hotspot-12 features."""
...
from open_cancer.residue_hotspot12 import ResidueHotspot12Family
...
CONFIG = ROOT / "configs" / "exp639_parser_v4_hotspot12.yaml"


class Hotspot12FoldBuilder:
    def __init__(self) -> None:
        ...
        self.family = ResidueHotspot12Family(self.gene_columns)
...
if __name__ == "__main__":
    main(
        CONFIG,
        fold_feature_builder=Hotspot12FoldBuilder(),
        ...
        runner_command="uv run python scripts/run_exp639_parser_v4_hotspot12.py",
    )
