#!/usr/bin/env python
"""Run EXP-497 (exploratory_ablation): EXP-392 rerun with the N6 (#493/#495)
isoform eligibility fix. Sibling of run_exp497_isoform_v4_eligibility_rerun.py
(the official EXP-374-parented rerun for this Issue); this variant checks
whether the fix's effect holds on top of EXP-392's range indicators too.
"""
...
from run_exp497_isoform_v4_eligibility_rerun import build_fold_features as build_parent_features
from run_hotspot_xgb import ROOT, main


CONFIG = ROOT / "configs" / "exp497_exp392_isoform_v4_rerun.yaml"
...
if __name__ == "__main__":
    main(
        ...
        runner_command="uv run python scripts/run_exp497_exp392_isoform_v4_rerun.py",
    )
