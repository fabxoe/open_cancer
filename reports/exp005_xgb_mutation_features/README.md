...
| 판단 | 제출 시점 1위·2026-07-30 23:13 KST 기준 2위, checkpoint 추론 재현 완료 |
...
대부분 값이 0이므로 CSR 희소행렬을 사용했다. 신뢰할 수 있는 원 transcript와
단백질 길이가 없어 단백질 상대 위치는 모델 입력에서 제외했다.
...
- 순위: **제출 시점 1위 → 2026-07-30 23:13 KST 기준 2위**

2026-07-30 23:13 KST 리더보드 화면에서 8조의 표시 점수는 0.29878, 제출
수는 2회였고 6조가 0.37149로 1위를 기록했다. 두 번째 제출의 실험 ID와 파일은
확인되지 않았으므로 이 보고서의 EXP-005 제출 이력에는 임의로 추가하지 않았다.
