...
### 2026-08-03 19:13 KST 리더보드 스냅샷

EXP-223이 계속 팀 대표 제출로 선택된 상태에서 8조의 Public 점수는 화면에
`0.32324`로 표시됐고, 정확한 제출 점수는 `0.323243525`였습니다. 팀 제출 수는
17회였으며 참가 4팀 중 4위였습니다.

| 순위 | 팀 | Public 표시 점수 | 제출 수 |
|---:|---|---:|---:|
| 1 | 5조 | 0.43525 | 15 |
| 2 | 6조 | 0.39517 | 17 |
| 3 | 7조 | 0.35205 | 12 |
...
이 표는 해당 시각의 화면 스냅샷이며 이후 순위 변화를 뜻하지 않습니다. 표시
점수는 소수 다섯 자리로 반올림되므로 실험 장부와 제출 비교에는 플랫폼 제출
목록의 정확한 값 `0.323243525`를 사용합니다.
