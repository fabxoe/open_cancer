...
| N4-S | native v3 분포·희소도·상관·adversarial AUC | #475 | explore | 미발급 | IN_PROGRESS | N/A | v2가 아닌 v3 기준, test·label을 feature 선택에 쓰지 않는 진단 | EXP-479 최종 행렬 감사 실행 |
| N4-SHAP | native v3 fold validation TreeSHAP·클래스별 기여 | #475 | explore | 미발급 | IN_PROGRESS | N/A | native feature competition·실사용 확인 | N4-S와 같은 분석 계약으로 실행 |
