...
| B | Fold-safe Hotspot-12 transformer | #632 | 해당 없음 | - | IN_PROGRESS | N/A | 구현·테스트 완료 후 PR |
| C | 공용 구현 병합 | #632 | 해당 없음 | - | PLANNED | N/A | CI 통과 후 merge |
| D | EXP-527 + Hotspot-12 공식 5-fold | 미발급 | 미발급 | - | PLANNED | N/A | C 병합 후 Experiment Issue 생성 |
