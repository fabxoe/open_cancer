...
- 확정된 다음 작업: EXP-078 `max+indicator` 공식 5-fold 실행
...
| B | max+indicator | [#78](https://github.com/fabxoe/open_cancer/issues/78) | EXP-078 | - | IN_PROGRESS | N/A | NOT_STARTED | - | 구현·공식 실행 |
